...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Devyansh Upadhyay — Portfolio" },
      { name: "description", content: "Two sides of the same semicolon — a dual-mode developer portfolio." },
      { name: "author", content: "Devyansh Upadhyay" },
      { property: "og:title", content: "Devyansh Upadhyay — Portfolio" },
